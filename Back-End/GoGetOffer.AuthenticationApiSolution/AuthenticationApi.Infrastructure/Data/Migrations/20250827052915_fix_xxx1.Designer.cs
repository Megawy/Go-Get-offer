...
namespace AuthenticationApi.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250827052915_fix_xxx1")]
    partial class fix_xxx1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AuthenticationApi.Domain.Entites.Auth.AuthenticationUserUpdateRequest", b =>
                {
                    ...
                    b.Property<Guid?>("AuthenticationUserId1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AuthenticationUserId1");
            ...
            modelBuilder.Entity("AuthenticationApi.Domain.Entites.Auth.AuthenticationUserUpdateRequest", b =>
                {
                    ...
                    b.HasOne("AuthenticationApi.Domain.Entites.Auth.AuthenticationUser", null)
                        .WithMany("AuthenticationUserUpdateRequests")
                        .HasForeignKey("AuthenticationUserId1");
